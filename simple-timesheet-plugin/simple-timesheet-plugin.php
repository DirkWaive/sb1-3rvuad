<?php
/*
Plugin Name: Simple Timesheet Plugin
Description: A comprehensive timesheet submission form with email output and data persistence
Version: 1.0
Author: Your Name
*/

function simple_timesheet_shortcode() {
    ob_start();
    ?>
    <div id="simple-timesheet-container">
        <form id="simple-timesheet-form">
        ...
        <div id="simple-timesheet-output"></div>
...
function simple_timesheet_enqueue_assets() {
    wp_enqueue_style('simple-timesheet-style', plugins_url('css/style.css', __FILE__));
    wp_enqueue_script('simple-timesheet-script', plugins_url('js/script.js', __FILE__), array('jquery'), '1.0', true);
    wp_localize_script('simple-timesheet-script', 'timesheetAjax', array('ajaxurl' => admin_url('admin-ajax.php')));
}
...
add_shortcode('simple_timesheet', 'simple_timesheet_shortcode');
add_action('wp_enqueue_scripts', 'simple_timesheet_enqueue_assets');
